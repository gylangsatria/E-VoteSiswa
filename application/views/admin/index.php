...
<div class="row">
    <div class="box col-md-12">
        <div class="box-inner">
            ...
            <div class="box-content">
                <p> E-VoteSiswa Adalah sebuah aplikasi yang didesain khusus untuk Pemilihan Ketua Osis <br/>
                    Aplikasi ini menggunakan Template <b>Charisma</b> dan dibangun menggunakan Framework <b>Code Igniter</b> 
                    <br/><br/>
                    Dengan adanya Aplikasi ini saya harap dapat membatu sekolah untuk melakukan Vote Ketua OSIS dan MPK
                </p>
            </div>
        </div>
    </div>
